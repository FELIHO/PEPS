...
ForwardTest::ForwardTest(const ForwardTest &HPF){
...
ForwardTest& ForwardTest::operator= (const ForwardTest &HPF) {
  currentRebalancingIndex_ = HPF.currentRebalancingIndex_;
...
ForwardTest::ForwardTest(PnlMat* marketData, MonteCarlo* monteCarlo){
  currentRebalancingIndex_= 0;
...
void ForwardTest::updateCompo(PnlMat* marketData){
...
double ForwardTest::HedgeError(PnlMat * marketData){
...
void ForwardTest::updatePast(PnlMat* marketData,int indexRebalancement,int indexToUpdate){
