...
int main(){
  ...
  str32 = str32+"market-data/market-data/simul_asian.dat";
  ...
  Asian asian_test = Asian(T, n_timestep , size, strike, payOffCoeff);
  MonteCarlo mc_test = MonteCarlo(&bc , &asian_test, n_samples, rng, h);
